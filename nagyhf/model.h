...
/// @param preallocatedDerBuffer a preallocated buffer to store the derivatives of the neurons. It is cheaper this way.
/// @param preallocatedValueBuffer a preallocated buffer to store the values of the neurons.
